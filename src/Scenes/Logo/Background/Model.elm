module Scenes.Logo.Background.Model exposing
    ( initModel
    , updateModel
    , viewModel
    )
...
import Scenes.Logo.Background.Common exposing (EnvC, Model, nullModel)
...
viewModel env model =
    group [ imageSmoothing False ] [ renderLogo env model, renderBlack env model ]
...
renderLogo : EnvC -> Model -> Renderable
renderLogo env model =
