module Scenes.Transition1.Room.Global exposing (getLayerT)
...
import Scenes.Transition1.Room.Common exposing (EnvC, nullModel)
import Scenes.Transition1.Room.Export exposing (Data)
