module Scenes.Transition1.Room.Model exposing
    ( initModel
    , updateModel
    , viewModel
    )
...
import Scenes.Transition1.Room.Common exposing (Camera, Character, Dir(..), EnvC, Map, Model, SceneState(..), Textbox)
...
nextLevel model _ =
    if model.sceneState == Free && member 67 model.keyList then
        [ ( LayerParentScene, LayerChangeSceneMsg "Level2" ) ]
